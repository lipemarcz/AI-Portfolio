...
* **Impacto:** Redução no tempo de entrega de planos nutricionais e gestão centralizada de dados clínicos.
* **Ciclo de Vida:** CI/CD ativo com entregas semanais baseadas em feedback real de campo.
* **Tech Stack:** React, Supabase (PostgreSQL), TypeScript, Integrações via API.
